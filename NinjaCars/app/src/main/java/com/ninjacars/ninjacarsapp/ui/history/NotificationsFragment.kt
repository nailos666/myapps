package com.ninjacars.ninjacarsapp.ui.history
...
import com.ninjacars.ninjacarsapp.R
import com.ninjacars.ninjacarsapp.models.Task2
import com.ninjacars.ninjacarsapp.databinding.FragmentNotificationsBinding
import com.ninjacars.ninjacarsapp.models.UserData
import com.ninjacars.ninjacarsapp.ui.main.MyDialogFragment
...
class NotificationsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.clear.setOnClickListener {
            val myDialogFragment = MyDialogFragment("Вы действительно желаете очистить журнал сохраненных расчетов?", name!!,numb!!   )
    ...
    fun onItemCkick(item: Task2) {
     ...
     findNavController().navigate(R.id.action_navigation_notifications_to_carInfoFragment,bundle)
    }
