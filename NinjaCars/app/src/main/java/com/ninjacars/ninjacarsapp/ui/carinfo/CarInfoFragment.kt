package com.ninjacars.ninjacarsapp.ui.carinfo
...
import com.ninjacars.ninjacarsapp.databinding.FragmentCarInfoBinding
...
class CarInfoFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var autoName = arguments?.getString("nameAuto").toString()
...
if (it.isNotEmpty()) {
    ...
    with(it[0].params) {
        ...
        listParams.add(CarInfoModel("Услуги брокера и оформление","$brokerageServicesRegistration")
        )
        }
